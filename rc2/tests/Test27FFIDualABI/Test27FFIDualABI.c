...
// idris2rc2_test50_* absorbed from former Test50FFIInlineNoWorker.c --
// same CFType shapes, exercising Compiler.RC2.DualABI's Stage 5 inline
// path instead of a synthesized FFI worker.
