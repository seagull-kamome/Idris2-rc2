...
## コーディング規約
コードを書く際には言語中立コーディング規約 code-style.md を読みその規約に従う事
...
- When changing codegen (`Compiler/RC2/Emit.idr`, `Emit/Util.idr`,
  `Emit/Foreign.idr`, `RC.idr`, `Types.idr`, `RCExp.idr`), verify the generated C against real RefC
